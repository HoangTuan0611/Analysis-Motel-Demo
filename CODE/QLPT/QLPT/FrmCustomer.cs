    ...
    public partial class FrmCustomer : Form
    {
        ...
        private void grdCustomer_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                txtCusName.Text = grdCustomer.Rows[dong].Cells[1].Value.ToString();      
                txtIdenCard.Text = grdCustomer.Rows[dong].Cells[2].Value.ToString();              
                txtJob.Text = grdCustomer.Rows[dong].Cells[4].Value.ToString();
                txtPhoneNumber.Text = grdCustomer.Rows[dong].Cells[5].Value.ToString();
                if (grdCustomer[3, grdCustomer.CurrentRow.Index].Value.ToString() == "Nam")
                {
